...
function swApplyScale(){jQuery('.nc_socialPanel').each(function(){jQuery(this).css({width:'100%'});var width=jQuery(this).width();var scale=jQuery(this).attr('data-scale');var align=jQuery(this).attr('data-align');if((align=='fullWidth'&&scale!=1)||scale>1||jQuery(this).hasClass('nc_socialPanelSide')){newWidth=width / scale;jQuery(this).css('cssText','width:'+newWidth+'px!important;');jQuery(this).css({'transform':'scale('+scale+')','transform-origin':'left'});}else if(align!='fullWidth'&&scale<1){newWidth=width / scale;jQuery(this).css({'transform':'scale('+scale+')','transform-origin':align});}});}
